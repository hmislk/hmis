...
WHERE TABLE_SCHEMA = DATABASE()
  ...
  AND COLUMN_NAME IN (
    ...
    'TOTALPAIDASCASH', 'TOTALPAIDASCARD', 'TOTALPAIDASCREDIT'
  )
ORDER BY COLUMN_NAME;

-- Sample data verification - check that existing values are preserved
SELECT ID, TOTALCOSTVALUE, TOTALPURCHASEVALUE, TOTALRETAILSALEVALUE,
       TOTALPAIDASCASH, TOTALPAIDASCARD, TOTALQUANTITY
...
-- ALL financial precision issues in BILLFINANCEDETAILS table have been resolved
-- Reports will now show accurate decimal values instead of rounded integers
-- Impact: Pharmacy reports, financial reports, payment reconciliation all improved