...
import com.divudi.bean.common.ConsultantFacade;
...
public class ConsultantController implements Serializable {
    ...
    @EJB
    private com.divudi.bean.common.ConsultantFacade ejbFacade;
    ...
    public Consultant getConsultant(java.lang.Long id) {
