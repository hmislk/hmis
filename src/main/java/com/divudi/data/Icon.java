...
public enum Icon {
    ...
    // icons for Ophthalmology Section
    Ophthalmology_EMR("Ophthalmology - EMR Management"),
    Ophthalmology_Patient_Management("Ophthalmology - Patient Management"),
    Ophthalmology_Appointment_Management("Ophthalmology - Appointment Management"),
    Ophthalmology_Stock_Management("Ophthalmology - Stock Management"),
    Ophthalmology_Product_Catalog("Ophthalmology - Product Catalog"),
    Ophthalmology_Repair_Management("Ophthalmology - Repair Management"),
    Ophthalmology_Retail_Sale("Ophthalmology - Retail Sale"),
