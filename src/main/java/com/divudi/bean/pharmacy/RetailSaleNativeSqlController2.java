...
/**
 * Sale window 3 copy of {@link RetailSaleNativeSqlController}.
 *
...
@Named
@SessionScoped
public class RetailSaleNativeSqlController2 implements Serializable, ControllerWithPatient, ControllerWithMultiplePayments {

    private static final Logger LOGGER = Logger.getLogger(RetailSaleNativeSqlController2.class.getName());
    ...
    public String pharmacyRetailSaleNative() {
        ...
        return "/pharmacy/pharmacy_bill_retail_sale_native_2?faces-redirect=true";
    }
