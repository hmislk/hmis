...
/**
 * Sale window 2 copy of {@link RetailSaleNativeSqlController}.
 *
...
@Named
@SessionScoped
public class RetailSaleNativeSqlController1 implements Serializable, ControllerWithPatient, ControllerWithMultiplePayments {

    private static final Logger LOGGER = Logger.getLogger(RetailSaleNativeSqlController1.class.getName());
    ...
    public String pharmacyRetailSaleNative() {
        ...
        return "/pharmacy/pharmacy_bill_retail_sale_native_1?faces-redirect=true";
    }
