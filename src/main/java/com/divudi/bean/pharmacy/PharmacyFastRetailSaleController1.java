...
/**
 * Fast Retail Sale Controller for Sale 2
 * @author Buddhika
 */
@Named
@SessionScoped
public class PharmacyFastRetailSaleController1 extends PharmacyFastRetailSaleController implements Serializable, ControllerWithPatient, ControllerWithMultiplePayments {

    /**
     * Creates a new instance of PharmacyFastRetailSaleController1
     */
    public PharmacyFastRetailSaleController1() {
    }

    public String navigateToPharmacyFastRetailSale1() {
        if (sessionController.getPharmacyBillingAfterShiftStart()) {
            financialTransactionController.findNonClosedShiftStartFundBillIsAvailable();
            if (financialTransactionController.getNonClosedShiftStartFundBill() != null) {
                resetAll();
                setBillSettlingStarted(false);
                return "/pharmacy/pharmacy_fast_retail_sale_1?faces-redirect=true";
            } else {
    ...
    @FacesConverter("stockDtoConverter1")
    public static class StockDtoConverter1 implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            try {
                ...
                PharmacyFastRetailSaleController1 controller = (PharmacyFastRetailSaleController1) facesContext.getApplication().getELResolver()
                        .getValue(facesContext.getELContext(), null, "pharmacyFastRetailSaleController1");
