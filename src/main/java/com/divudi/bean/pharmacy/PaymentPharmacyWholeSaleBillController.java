...
@Named
@SessionScoped
public class PaymentPharmacyWholeSaleBillController implements Serializable {
...
//        }
    ...
    public PaymentPharmacyWholeSaleBillController() {
    }
    ...
    public static class StaffPaymentBillControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            PaymentPharmacyWholeSaleBillController controller = (PaymentPharmacyWholeSaleBillController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof BilledBill) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type "
                        + object.getClass().getName() + "; expected type: " + PaymentPharmacyWholeSaleBillController.class.getName());
            }
        }
    }
}
