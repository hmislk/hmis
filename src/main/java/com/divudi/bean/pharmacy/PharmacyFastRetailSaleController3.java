...
/**
 * Fast Retail Sale Controller for Sale 4
 * @author Buddhika
 */
@Named
@SessionScoped
public class PharmacyFastRetailSaleController3 extends PharmacyFastRetailSaleController implements Serializable, ControllerWithPatient, ControllerWithMultiplePayments {

    /**
     * Creates a new instance of PharmacyFastRetailSaleController3
     */
    public PharmacyFastRetailSaleController3() {
    }

    public String navigateToPharmacyFastRetailSale3() {
        if (sessionController.getPharmacyBillingAfterShiftStart()) {
            financialTransactionController.findNonClosedShiftStartFundBillIsAvailable();
            if (financialTransactionController.getNonClosedShiftStartFundBill() != null) {
                resetAll();
                setBillSettlingStarted(false);
                return "/pharmacy/pharmacy_fast_retail_sale_3?faces-redirect=true";
            } else {
    ...
    @FacesConverter("stockDtoConverter3")
    public static class StockDtoConverter3 implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            try {
                ...
                PharmacyFastRetailSaleController3 controller = (PharmacyFastRetailSaleController3) facesContext.getApplication().getELResolver()
                        .getValue(facesContext.getELContext(), null, "pharmacyFastRetailSaleController3");
