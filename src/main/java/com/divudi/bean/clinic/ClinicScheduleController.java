...
@Named
@SessionScoped
public class ClinicScheduleController implements Serializable {
//SheduleController
    ...
    @Inject
    ClinicScheduleController channelScheduleController;
    @Inject
...
//        itemController.fillItemsForInward();
        return "/clinic/clinic_shedule?faces-redirect=true";
    }
    ...
    public ClinicScheduleController() {
    }
