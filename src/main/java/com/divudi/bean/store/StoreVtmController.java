...
public class StoreVtmController implements Serializable {
    ...
    public void setSelectedVtmDto(VtmDto selectedVtmDto) {
        ...
        if (selectedVtmDto != null && selectedVtmDto.getId() != null) {
            ...
            this.current = isInStoreScope(loaded) ? loaded : null;
        } else {
            this.current = null;
        }
    }
     ...
     */
    private static boolean isInStoreScope(Vtm vtm) {
        return vtm != null && !vtm.isRetired() && vtm.getDepartmentType() == DepartmentType.Store;
    }
