    ...
    if (reportKeyWord.getPaymentMethod() == PaymentMethod.Credit) {
      for (PatientEncounter pe : fetchPatientEncounters(fromDate, toDate, PaymentMethod.Credit, null, getReportKeyWord().getAdmissionType(), null)) {
        ...
        if (grantTot != 0.0) {
          ...
          qbf.setAmount(grantTot);
          qbf.setMemo("");
          qbf.setDocNum(pe.getFinalBill().getInsId());
      ...
      if (getReportKeyWord().getAdmissionType() != null) {
        ...
        if (grantTot != 0.0) {
          ...
          qbf.setDate(sdf.format(fromDate));
          qbf.setEditDate(true);
          qbf.setAccnt("RECEIVABLES:Debetors Contol " + getReportKeyWord().getAdmissionType().getName());
          sdf = new SimpleDateFormat("MMM yyyy");
          qbf.setName(getReportKeyWord().getAdmissionType().getName() + " Cash Customer-" + sdf.format(fromDate));
          qbf.setAmount(grantTot);
          qbf.setMemo("");
...
//            System.out.println("d = " + d);
      if (itemBefore == null) {
        ...
        if (Investigation.class == i.getClass()) {
          qbf.setAccnt("INCOME ACCOUNTS:RHD Lab Income:RHD OPD Sale");
        } else {
...
//            System.out.println("d = " + d);
      if (itemBefore == null) {
        ...
        if (paymentMethod == PaymentMethod.Credit) {
          if (pe != null) {
            qbf = new QuickBookFormat(cat.getName(), pe.getCreditCompany().getName(), i.getName(), 0 - sum, s);
          } else {
            qbf = new QuickBookFormat(cat.getName(), "No Bht", i.getName(), 0 - sum, s);
          }
        } else {
          qbf = new QuickBookFormat(cat.getName(), i.getName(), i.getName(), 0 - sum, s);
        }
        if (Investigation.class == i.getClass()) {
...
//                        qbf.setAccnt(cat.getName() + " I");
      ...
      if (paymentMethod == PaymentMethod.Credit) {
        if (pe != null) {
          ...
          if (getReportKeyWord().isBool1()) {
            qbf = new QuickBookFormat("INCOME ACCOUNTS:Dialysis Unit", pe.getCreditCompany().getName(), "Dialysis", ((double) obj[0] + (double) obj[1] + (double) obj[2] + (double) obj[3] + (double) obj[4] + (double) obj[5] + (double) obj[6]), pe.getCurrentPatientRoom().getRoomFacilityCharge().getDepartment().getName());
            if (qbf.getAmount() != 0.0) {
              qbfs.add(qbf);
            }
          } else {
            qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.RoomCharges.toString(), pe.getCreditCompany().getName(), InwardChargeType.RoomCharges.toString(), (double) obj[0], pe.getCurrentPatientRoom().getRoomFacilityCharge().getDepartment().getName());
            if (qbf.getAmount() != 0.0) {
              qbfs.add(qbf);
            }
            qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.MaintainCharges.toString(), pe.getCreditCompany().getName(), InwardChargeType.MaintainCharges.toString(), (double) obj[1], pe.getCurrentPatientRoom().getRoomFacilityCharge().getDepartment().getName());
            if (qbf.getAmount() != 0.0) {
              qbfs.add(qbf);
            }
            qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.MOCharges.toString(), pe.getCreditCompany().getName(), InwardChargeType.MOCharges.toString(), (double) obj[2], pe.getCurrentPatientRoom().getRoomFacilityCharge().getDepartment().getName());
            if (qbf.getAmount() != 0.0) {
              qbfs.add(qbf);
            }
            qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.NursingCharges.toString(), pe.getCreditCompany().getName(), InwardChargeType.NursingCharges.toString(), (double) obj[3], pe.getCurrentPatientRoom().getRoomFacilityCharge().getDepartment().getName());
            if (qbf.getAmount() != 0.0) {
              qbfs.add(qbf);
            }
            qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.LinenCharges.toString(), pe.getCreditCompany().getName(), InwardChargeType.LinenCharges.toString(), (double) obj[4], pe.getCurrentPatientRoom().getRoomFacilityCharge().getDepartment().getName());
            if (qbf.getAmount() != 0.0) {
              qbfs.add(qbf);
            }
            qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.AdministrationCharge.toString(), pe.getCreditCompany().getName(), InwardChargeType.AdministrationCharge.toString(), (double) obj[5], pe.getCurrentPatientRoom().getRoomFacilityCharge().getDepartment().getName());
            if (qbf.getAmount() != 0.0) {
              qbfs.add(qbf);
            }
            qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.MedicalCareICU.toString(), pe.getCreditCompany().getName(), InwardChargeType.MedicalCareICU.toString(), (double) obj[6], pe.getCurrentPatientRoom().getRoomFacilityCharge().getDepartment().getName());
            if (qbf.getAmount() != 0.0) {
              qbfs.add(qbf);
            }
          }
        ...
        qbf = new QuickBookFormat();
        if (getReportKeyWord().isBool1()) {
          qbf = new QuickBookFormat("INCOME ACCOUNTS:Dialysis Unit", "Dialysis", "Dialysis", ((double) obj[0] + (double) obj[1] + (double) obj[2] + (double) obj[3] + (double) obj[4] + (double) obj[5] + (double) obj[6]), "Ward Bed");
          if (qbf.getAmount() != 0.0) {
            qbfs.add(qbf);
          }
        } else {
          qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.RoomCharges.toString(), InwardChargeType.RoomCharges.toString(), InwardChargeType.RoomCharges.toString(), (double) obj[0], "Ward Bed");
          if (qbf.getAmount() != 0.0) {
            qbfs.add(qbf);
          }
          qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.MaintainCharges.toString(), InwardChargeType.MaintainCharges.toString(), InwardChargeType.MaintainCharges.toString(), (double) obj[1], "Ward Bed");
          if (qbf.getAmount() != 0.0) {
            qbfs.add(qbf);
          }
          qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.MOCharges.toString(), InwardChargeType.MOCharges.toString(), InwardChargeType.MOCharges.toString(), (double) obj[2], "Ward Bed");
          if (qbf.getAmount() != 0.0) {
            qbfs.add(qbf);
          }
          qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.NursingCharges.toString(), InwardChargeType.NursingCharges.toString(), InwardChargeType.NursingCharges.toString(), (double) obj[3], "Ward Bed");
          if (qbf.getAmount() != 0.0) {
            qbfs.add(qbf);
          }
          qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.LinenCharges.toString(), InwardChargeType.LinenCharges.toString(), InwardChargeType.LinenCharges.toString(), (double) obj[4], "Ward Bed");
          if (qbf.getAmount() != 0.0) {
            qbfs.add(qbf);
          }
          qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.AdministrationCharge.toString(), InwardChargeType.AdministrationCharge.toString(), InwardChargeType.AdministrationCharge.toString(), (double) obj[5], "Ward Bed");
          if (qbf.getAmount() != 0.0) {
            qbfs.add(qbf);
          }
          qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.MOCharges.toString(), InwardChargeType.MedicalCareICU.toString(), InwardChargeType.MedicalCareICU.toString(), (double) obj[6], "Ward Bed");
          if (qbf.getAmount() != 0.0) {
            qbfs.add(qbf);
          }
        }
  ...
  public List<QuickBookFormat> fetchInwardDoctorPayment(Date fd, Date td, PatientEncounter pe, AdmissionType admissionType, PaymentMethod paymentMethod, Institution cc) {
    ...
    for (Object[] o : objects) {
      ...
      QuickBookFormat qbf = new QuickBookFormat(sp, sp, sp, value, "Ward");
      if (value != 0.0) {
        grantTot += value;
        qbfs.add(qbf);
...
//                + " and i.patientEncounter.discharged=true ";
    ...
    for (Object[] obj : results) {
      ...
      QuickBookFormat qbf = new QuickBookFormat(cat.getDescription(), item.getName(), item.getName(), value, item.getDepartment().getName());
      grantTot += value;
      qbfs.add(qbf);
    }
  ...
  public List<QuickBookFormat> fetchInwardOtherService(Date fd, Date td, PatientEncounter pe, AdmissionType admissionType, PaymentMethod paymentMethod, Institution cc) {
    ...
    QuickBookFormat qbf;
    if (getReportKeyWord().isBool1()) {
      qbf = new QuickBookFormat("INCOME ACCOUNTS:Dialysis Unit", InwardChargeType.AdmissionFee.getLabel(), InwardChargeType.AdmissionFee.getLabel(), d, InwardChargeType.AdmissionFee.getLabel());
    } else if (getReportKeyWord().isBool2()) {
      qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.AdmissionFee.getLabel() + " Green Sheet", InwardChargeType.AdmissionFee.getLabel(), InwardChargeType.AdmissionFee.getLabel(), d, InwardChargeType.AdmissionFee.getLabel());
    } else {
      qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.AdmissionFee.getLabel(), InwardChargeType.AdmissionFee.getLabel(), InwardChargeType.AdmissionFee.getLabel(), d, InwardChargeType.AdmissionFee.getLabel());
    }
    if (qbf.getAmount() != 0.0) {
      qbfs.add(qbf);
    }
    ...
    if (getReportKeyWord().isBool2()) {
      qbf = new QuickBookFormat("PHARMACY SALES:Green Sheet Sales", InwardChargeType.Medicine.getLabel(), InwardChargeType.Medicine.getLabel(), d, InwardChargeType.Medicine.getLabel());
    } else {
      qbf = new QuickBookFormat("PHARMACY SALES:Inward Sales", InwardChargeType.Medicine.getLabel(), InwardChargeType.Medicine.getLabel(), d, InwardChargeType.Medicine.getLabel());
    }
    if (qbf.getAmount() != 0.0) {
      qbfs.add(qbf);
    }
    ...
    grantTot += d;
    qbf = new QuickBookFormat("INCOME ACCOUNTS:" + InwardChargeType.GeneralIssuing.getLabel(), InwardChargeType.GeneralIssuing.getLabel(), InwardChargeType.GeneralIssuing.getLabel(), d, InwardChargeType.GeneralIssuing.getLabel());
    if (qbf.getAmount() != 0.0) {
      qbfs.add(qbf);
    }
    d = fetchOutSideFee(fd, td, pe, admissionType, paymentMethod, cc);
    grantTot += d;
    qbf = new QuickBookFormat("ACCRUED CHARGES:Indoor Patient Payable", "Out Side Charges", "Out Side Charges", d, "Out Side Charges");
    if (qbf.getAmount() != 0.0) {
      qbfs.add(qbf);
    }
