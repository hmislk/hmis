...
public class RelationshipController implements Serializable {
    ...
    List<Relationship> selectedItems;
    private Relationship current;
    private List<Relationship> items = null;
    String selectText = "";

    public List<Relationship> getSelectedItems() {
        selectedItems = getFacade().findBySQL("select c from Relationship c where c.retired=false and upper(c.name) like '%" + getSelectText().toUpperCase() + "%' order by c.name");
    ...
    public void setSelectedItems(List<Relationship> selectedItems) {
    ...
    public void setEjbFacade(RelationshipFacade ejbFacade) {
    ...
    public void setCurrent(Relationship current) {
    ...
    public List<Relationship> getItems() {
        if (items == null) {
            String jpql = "Select r from Relationship r where r.retired=false order by r.orderNo";
    ...
    public static class RelationshipConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Relationship) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type "
                        + object.getClass().getName() + "; expected type: " + RelationshipController.class.getName());
            }
        }
    }
