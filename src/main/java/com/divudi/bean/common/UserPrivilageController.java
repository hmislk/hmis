...
public class UserPrivilageController implements Serializable {
    ...
    private TreeNode createTreeNode() {
        ...
        TreeNode node227b = new PrivilageNode("Mannage Items", node227);
        TreeNode node227ba = new PrivilageNode("Mannage Items Menu", node227b, Privileges.LabItems);
        TreeNode node227bb = new PrivilageNode("Mannage Item Fee Update", node227b, Privileges.LabItemFeeUpadate);
        TreeNode node227bc = new PrivilageNode("Mannage Item Fee Delete", node227b, Privileges.LabItemFeeDelete);
        TreeNode node227c = new PrivilageNode("Mannage Reports", node227);
        TreeNode node227ca = new PrivilageNode("Mannage Reports Menu", node227c, Privileges.LabReports);
        TreeNode node227d = new PrivilageNode("Lists", node227);
        TreeNode node227da = new PrivilageNode("Lists Menu", node227d, Privileges.LabLists);
        TreeNode node227e = new PrivilageNode("Setup", node227);
        TreeNode node227ea = new PrivilageNode("Setup Menu", node227e, Privileges.LabSetUp);
