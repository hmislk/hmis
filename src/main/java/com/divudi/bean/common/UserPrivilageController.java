...
public class UserPrivilageController implements Serializable {
    ...
    private TreeNode<PrivilegeHolder> createPrivilegeHolderTreeNodes() {
        ...
        // Expose stock adjustment privileges
        new DefaultTreeNode(new PrivilegeHolder(Privileges.PharmacyStockAdjustment, "Pharmacy Stock Adjustment"), PharmacyAdjustment);
        new DefaultTreeNode(new PrivilegeHolder(Privileges.PharmacyStockAdjustmentSingleItem, "Pharmacy Stock Adjustment Single Item"), PharmacyAdjustment);
