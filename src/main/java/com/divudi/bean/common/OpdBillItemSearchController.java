    ...
    public void createTable() {
        ...
        if (txtSearch == null || txtSearch.trim().equals("")) {
            ...
            sql = "select bi from BillItem bi join bi.bill b join b.patient.person"
                    ...
                    + " or (b.patient.person.phone) like '%" + txtSearch.toUpperCase() + "%' "
                    + "  or (b.insId) like '%" + txtSearch.toUpperCase() + "%' or "
                    + " (b.toInstitution.name) like '%" + txtSearch.toUpperCase() + "%' "
                    + " or (b.paymentMethod) like '%" + txtSearch.toUpperCase() + "%' "
                    + " or (b.paymentScheme.name) like '%" + txtSearch.toUpperCase() + "%' "
                    + " or (b.netTotal) like '%" + txtSearch.toUpperCase() + "%' "
                    + " or (b.total) like '%" + txtSearch.toUpperCase() + "%' ) "
                    + " and b.createdAt between :fromDate and :toDate order by bi.id desc";
        }
