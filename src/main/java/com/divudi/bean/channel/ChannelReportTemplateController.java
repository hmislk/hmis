...
public class ChannelReportTemplateController implements Serializable {
    private static final Logger LOG = Logger.getLogger(ChannelReportTemplateController.class.getName());
...
//        hm.put("class", BilledBill.class);
    ...
    public void processAndfillDailySessionCounts() {
        LOG.log(Level.INFO, "Starting processAndfillDailySessionCounts...");

        String j;
        Map<String, Object> m = new HashMap<>();
        rows = new ArrayList<>();

        LOG.log(Level.INFO, "Preparing JPQL query...");
        j = "select new com.divudi.core.data.ReportTemplateRow(si) "
                + " from SessionInstance si "
                + " where si.retired=false "
                + " and si.sessionDate between :fd and :td ";
        ...
        LOG.log(Level.INFO, "Setting date parameters: fromDate = " + fromDate + ", toDate = " + toDate);
        m.put("fd", fromDate);
        m.put("td", toDate);
        ...
        LOG.log(Level.INFO, "Processing result rows...");
...
//        }
        ...
        ////LOG.log(Level.INFO, "Billed,Cancell,Refund" + totalBilled + "," + totalCancel + "," + totalRefund);
        if (pay == PaymentMethod.Cash) {
            ////LOG.log(Level.INFO, "payment method=" + pay);
            ////LOG.log(Level.INFO, "Billed,Cancell,Refund" + totalBilled + "," + totalCancel + "," + totalRefund);
        ...
        ////LOG.log(Level.INFO, "chmlst = " + chmlst);
        chmlst.add(chm);
    }
...
//    }
    ...
    public void updateChannelCancelBillFee(Bill b) {
        ...
        m.put("bt", bt);
        ////LOG.log(Level.INFO, "getBillSessionFacade().findByJpql(sql, m) = " + getBillSessionFacade().findByJpql(sql, m));
        List<BillSession> billSessions = getBillSessionFacade().findByJpql(sql, m);
        ////LOG.log(Level.INFO, "billSessions = " + billSessions.size());
        for (BillSession bs : billSessions) {
            ////LOG.log(Level.INFO, "In");
            bs.getBill().setSingleBillSession(bs);
            ////LOG.log(Level.INFO, "bs.getSingleBillSession() = " + bs.getBill().getSingleBillSession());
...
//        //LOG.log(Level.INFO, "getBillFeeFacade().findAggregateLong(sql, m, TemporalType.TIMESTAMP) = " + d);
//        return d;
//    }
...
//        m.put("class", bill.getClass());
//        m.put("bt", bt);
//        //LOG.log(Level.INFO, "getBillFeeFacade().findDoubleByJpql(sql, m, TemporalType.TIMESTAMP) = " + getBillFeeFacade().findDoubleByJpql(sql, m, TemporalType.TIMESTAMP));
...
//    }
    ...
    public List<DoctorPaymentSummeryRowSub> getSessionTotal(List<BillType> bts, BillType bt, Staff staff) {
        ...
        for (ServiceSession ss : getServiceSessions(fromDate, toDate, staff)) {
            ...
            for (Bill b : dpsrs.getBills()) {
                ...
                //LOG.log(Level.INFO, "cashCount = " + cashCount);
            ...
            //LOG.log(Level.INFO, "dpsrs.getCashCount() = " + dpsrs.getCashCount());
    ...
    public List<DoctorPaymentSummeryRowSub> getDoctorPaymentSummeryRowSubs(List<BillType> bts, BillType bt, Staff staff, Date fd, Date td) {
        ...
        while (nowDate.before(td)) {
            ...
            //LOG.log(Level.INFO, "formattedDate = " + formattedDate);
            //LOG.log(Level.INFO, "nowDate = " + nowDate);
            ...
            //LOG.log(Level.INFO, "doctorPaymentSummeryRowSub.getDate() = " + doctorPaymentSummeryRowSub.getDate());
    ...
    public List<Bill> getChannelUnPaidBillListbyClassTypes(List<BillType> bts, Date d, Staff stf) {
        //LOG.log(Level.INFO, "Inside getChannelUnPaidBillListbyClassTypes");
        HashMap hm = new HashMap();
    ...
    public List<DoctorPaymentSummeryRowSub> getDoctorPaymentSummeryRowSubsBySession(List<BillType> bts, BillType bt, Staff staff, Date fd, Date td) {
        ...
        while (nowDate.before(td)) {
            ...
            for (ServiceSession ss : sessions) {
                ...
                doctorPaymentSummeryRowSub.setDate(nowDate);
                //LOG.log(Level.INFO, "doctorPaymentSummeryRowSub.getServiceSession() = " + doctorPaymentSummeryRowSub.getServiceSession());
                //LOG.log(Level.INFO, "doctorPaymentSummeryRowSub.getDate() = " + doctorPaymentSummeryRowSub.getDate());
    ...
    public List<Bill> getChannelPaymentBillListbyClassTypes(List<BillType> bts, BillType bt, Date d, Date sessionFDate, Date sessionTDate, Staff stf, ServiceSession ss) {
        //LOG.log(Level.INFO, "Inside getStaffbyClassType");
        HashMap hm = new HashMap();
...
//        //LOG.log(Level.INFO, "getStaffbyClassType(bts) = " + getStaffbyClassType(bts, fromDate, toDate));
...
//                row.setRefundCount(hospitalTotalBillByBillTypeAndFeeType(new RefundBill(), FeeType.OwnInstitution, bt, sessionDate, paid));
    ...
    public List<Bill> channelBillList(boolean createdDate, Bill bill, boolean paid, Staff s, Speciality sp, Area area) {
        ...
        if (!createdDate) {
            ...
            for (Bill b : bills) {
//                //LOG.log(Level.INFO, "b.getSingleBillSession().getSessionDate() = " + b.getSingleBillSession().getSessionDate());
//                //LOG.log(Level.INFO, "b.getSingleBillSession().getSessionTime() = " + b.getSingleBillSession().getSessionTime());
                Calendar d = Calendar.getInstance();
                d.setTime(b.getSingleBillSession().getSessionDate());
                Calendar t = Calendar.getInstance();
                t.setTime(b.getSingleBillSession().getSessionTime());
//                //LOG.log(Level.INFO, "t.get(Calendar.HOUR) = " + t.get(Calendar.HOUR));
//                //LOG.log(Level.INFO, "t.get(Calendar.HOUR_OF_DAY) = " + t.get(Calendar.HOUR_OF_DAY));
//                //LOG.log(Level.INFO, "t.get(Calendar.MINUTE) = " + t.get(Calendar.MINUTE));
//                //LOG.log(Level.INFO, "t.get(Calendar.SECOND) = " + t.get(Calendar.SECOND));
//                Calendar cal = Calendar.getInstance();
...
//                //LOG.log(Level.INFO, "cal.getTime() = " + cal.getTime());
    ...
    public void channelAreaWithCount(boolean createdDate) {
        ...
        if (summery) {
            ...
            for (Object[] ob : objects) {
                ...
                //LOG.log(Level.INFO, "a.getName() = " + a.getName());
            ...
            for (Object[] ob : objects) {
                ...
                //LOG.log(Level.INFO, "s.getPerson().getName() = " + s.getPerson().getName());
                if (classType == BillClassType.BilledBill) {
                    total += count;
                } else {
                    total -= count;
    ...
    public void setFeeTotals(List<String1Value3> s1v3s, FeeType feeType) {
        ...
        ////LOG.log(Level.INFO, "*************");
        ////LOG.log(Level.INFO, "Fee - " + s1v3.getString());
        ////LOG.log(Level.INFO, "Bill - " + s1v3.getValue1());
        ////LOG.log(Level.INFO, "Can - " + s1v3.getValue2());
        ////LOG.log(Level.INFO, "Ref - " + s1v3.getValue3());
        s1v3s.add(s1v3);
...
//            //LOG.log(Level.INFO, "getReportKeyWord().getString() = " + getReportKeyWord().getString());
...
//                    //LOG.log(Level.INFO, "cal.get(Calendar.HOUR) = " + cal.get(Calendar.HOUR));
//                    //LOG.log(Level.INFO, "cal.get(Calendar.MINUTE) = " + cal.get(Calendar.MINUTE));
//                    //LOG.log(Level.INFO, "cal.get(Calendar.AM_PM) = " + cal.get(Calendar.AM_PM));
//                    //LOG.log(Level.INFO, "cal.get(Calendar.HOUR_OF_DAY) = " + cal.get(Calendar.HOUR_OF_DAY));
...
//                //LOG.log(Level.INFO, "reBills.size() = " + reBills.size());
...
//        //LOG.log(Level.INFO, "bills = " + bills.size());
        Set<Staff> consultant = new HashSet();
        for (Bill b : bills) {
            consultant.add(b.getStaff());
        }
...
//            System.err.println("cd = " + cd.getConsultant().getPerson().getName());
            for (Bill b : bills) {
//                //LOG.log(Level.INFO, "b = " + b.getStaff().getPerson().getName());
//                //LOG.log(Level.INFO, "b = " + b.getBillClass());
