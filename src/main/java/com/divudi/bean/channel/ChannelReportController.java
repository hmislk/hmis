...
//        List<BillSession> bsList = channelService.fetchScanningSessionBillSessions(fromDate, toDate, institution);
    ...
    public static class ChannelIncomeDetailDto{
        ...
        public ChannelIncomeDetailDto(long id, Date appoinmentDate, String patientName, String patientPhone, PaymentMethod paymentMethod, double doctorFee, double hosFee, double totalAppoinmentFee, String remark) {
            this.id = id;
