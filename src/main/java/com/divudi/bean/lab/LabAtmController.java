...
@Named
@SessionScoped
public class LabAtmController implements Serializable {
        ...
        try {
            ...
            if (getCurrent().getId() != null) {
                ...
                auditService.logAudit(beforeData, afterData,
                        ...
                        "LabAtm", "Update Lab ATM", getCurrent().getId());

                JsfUtil.addSuccessMessage("Lab ATM '" + getCurrent().getName() + "' updated successfully");
            } else {
                // CREATE
                ...
                auditService.logAudit(null, afterData,
                        getSessionController().getLoggedUser(),
                        "LabAtm", "Create Lab ATM", getCurrent().getId());

                JsfUtil.addSuccessMessage("Lab ATM '" + getCurrent().getName() + "' created successfully");
            ...
            JsfUtil.addErrorMessage("Error saving Lab ATM '" + (getCurrent().getName() != null ? getCurrent().getName() : "Unknown") + "': " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public void delete() {
        if (current != null) {
            ...
            try {
                ...
                auditService.logAudit(beforeData, afterData,
                        getSessionController().getLoggedUser(),
                        "LabAtm", "Delete Lab ATM", current.getId());

                JsfUtil.addSuccessMessage("Lab ATM '" + (atmName != null ? atmName : "Unknown") + "' deleted successfully");
            } catch (Exception e) {
                JsfUtil.addErrorMessage("Error deleting Lab ATM '" + (atmName != null ? atmName : "Unknown") + "': " + e.getMessage());
                e.printStackTrace();
            }
        } else {
    ...
    public void toggleAtmStatus() {
        ...
        if (wasInactive) {
            ...
            JsfUtil.addSuccessMessage("Lab ATM Activated Successfully");
        } else {
            current.setInactive(true);
            JsfUtil.addSuccessMessage("Lab ATM Deactivated Successfully");
        }

        getFacade().edit(current);

        Map<String, Object> afterData = createAuditMap(current);
        String action = wasInactive ? "Activate Lab ATM" : "Deactivate Lab ATM";
        auditService.logAudit(beforeData, afterData,
                getSessionController().getLoggedUser(),
                "LabAtm", action, current.getId());
    ...
    public String navigateToAuditEvents() {
        ...
        fillAtmAuditEvents();
        return "/pharmacy/admin/lab_atm_audit_events?faces-redirect=true";
    }
    ...
    @FacesConverter("labAtmDtoConverter")
    public static class LabAtmDtoConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            try {
                ...
                LabAtmController controller = (LabAtmController) facesContext.getApplication()
                        .getELResolver().getValue(facesContext.getELContext(), null, "labAtmController");
    ...
    public static class AtmControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            LabAtmController controller = (LabAtmController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "labAtmController");
