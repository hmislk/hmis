...
@Named
@SessionScoped
public class LabAmppController implements Serializable {
        ...
        try {
            if (getCurrent().getId() != null && getCurrent().getId() > 0) {
                ...
                auditService.logAudit(beforeEditData, afterData,
                        ...
                        "LabAmpp", "Update Lab AMPP", getCurrent().getId());
                ...
                auditService.logAudit(null, afterData,
                        getSessionController().getLoggedUser(),
                        "LabAmpp", "Create Lab AMPP", getCurrent().getId());
            ...
            JsfUtil.addErrorMessage("Error saving Lab AMPP: " + e.getMessage());
            e.printStackTrace();
        }
        ...
        if (current != null) {
            try {
                ...
                auditService.logAudit(beforeData, afterData,
                        getSessionController().getLoggedUser(),
                        "LabAmpp", "Delete Lab AMPP", current.getId());

                JsfUtil.addSuccessMessage("Deleted Successfully");
            } catch (Exception e) {
                JsfUtil.addErrorMessage("Error deleting Lab AMPP: " + e.getMessage());
                e.printStackTrace();
            }
        } else {
    ...
    public String getFilterStatusDisplay() {
        switch (filterStatus) {
            ...
            case "inactive":
                return "Inactive Lab AMPPs";
            case "all":
                return "All Lab AMPPs";
            default:
                return "Active Lab AMPPs";
        }
    }
    ...
    public void toggleAmppStatus() {
        ...
        if (wasInactive) {
            ...
            JsfUtil.addSuccessMessage("Lab AMPP Activated Successfully");
        } else {
            current.setInactive(true);
            JsfUtil.addSuccessMessage("Lab AMPP Deactivated Successfully");
        }

        getFacade().edit(current);

        Map<String, Object> afterData = createAuditMap(current);
        String action = wasInactive ? "Activate Lab AMPP" : "Deactivate Lab AMPP";
        auditService.logAudit(beforeData, afterData,
                getSessionController().getLoggedUser(),
                "LabAmpp", action, current.getId());
    ...
    public String navigateToAmppAuditEvents() {
        ...
        fillAmppAuditEvents();
        return "/pharmacy/admin/lab_ampp_audit_events?faces-redirect=true";
    }
    ...
    @FacesConverter("labAmppDtoConverter")
    public static class LabAmppDtoConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            try {
                ...
                LabAmppController controller = (LabAmppController) facesContext.getApplication()
                        .getELResolver().getValue(facesContext.getELContext(), null, "labAmppController");
