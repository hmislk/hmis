        ...
        JsonObject manageInvestigationFormatTool = Json.createObjectBuilder()
                ...
                .add("input_schema", Json.createObjectBuilder()
                        ...
                        .add("properties", Json.createObjectBuilder()
                                ...
                                .add("method", Json.createObjectBuilder()
                                        .add("type", "string")
                                        .add("description", "LIST=list all, GET=get by id, POST=create, PUT=update, DELETE=soft-retire. Required."))
                                ...
                                .add("id", Json.createObjectBuilder()
                                        .add("type", "string")
                                        .add("description", "Record ID for GET/PUT/DELETE on VALUE, CALCULATION, FLAG, DYNAMIC_LABEL."))
                                .add("name", Json.createObjectBuilder()
                                        .add("type", "string")
