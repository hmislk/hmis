...
public class InwardBhtChargeAggregationService implements Serializable {
    ...
    /**
     * BILL_FEE — Technician Fee category (nurses, technicians, other paramedical
     * staff). Its own bucket whatever the merge setting; neither query above
     * includes it (issue #23982).
     */
