 ...
 */
@Entity
public class UserStock implements Serializable, RetirableEntity  {
    ...
    public boolean equals(Object object) {
        ...
        UserStock other = (UserStock) object;
    ...
    public String toString() {
        return "com.divudi.core.entity.pharmacy.UserStock[ id=" + id + " ]";
    }
    ...
    public double getUpdationQty() {
        return updationQty;
    }

    public void setUpdationQty(double updationQty) {
        this.updationQty = updationQty;
    }
