...
public class PhDate implements Serializable {
    ...
    public String toString() {
        return "com.divudi.core.entity.hr.PhDate[ id=" + id + " ]";
    }
    ...
    public DayType getPhType() {
        return phType;
    }

    public void setPhType(DayType phType) {
        this.phType = phType;
    }
}
