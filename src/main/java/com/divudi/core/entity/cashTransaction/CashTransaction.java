...
import com.divudi.core.data.InOutType;
 ...
 */
@Entity
public class CashTransaction implements Serializable, RetirableEntity  {
...
///////////////////
    ...
    public String toString() {
        return "com.divudi.core.entity.CashTransaction[ id=" + id + " ]";
    }
