...
public enum BillTypeAtomic {
    ...
    PHARMACY_RETURN_WITHOUT_TREASING_GRN("Pharmacy GRN Return without a Receipt", BillCategory.REFUND, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.NO_PAYMENT),
    PHARMACY_RETURN_WITHOUT_TREASING_DIRECT_PURCHASE("Pharmacy Direct Purchase Return without a Receipt", BillCategory.REFUND, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.NO_PAYMENT),
    // CHANNELLING
