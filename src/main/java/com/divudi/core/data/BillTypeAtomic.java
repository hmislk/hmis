...
public enum BillTypeAtomic {
    ...
    FUND_TRANSFER_REQUEST("Fund Transfer Request", BillCategory.BILL, ServiceType.OTHER, BillFinanceType.FLOAT_CHANGE, CountedServiceType.OTHER, PaymentCategory.NON_CREDIT_SPEND, BillType.FundTransferRequestBill),
    FUND_TRANSFER_REQUEST_CANCELLED("Fund Transfer Request - Cancelled", BillCategory.CANCELLATION, ServiceType.OTHER, BillFinanceType.FLOAT_CHANGE, CountedServiceType.OTHER, PaymentCategory.NON_CREDIT_SPEND, BillType.FundTransferRequestBill),
