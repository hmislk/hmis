...
public enum BillTypeAtomic {
    ...
    INWARD_PROFESSIONAL_FEE_BILL_CANCELLATION("Inward Professional Fee Bill Cancellation", BillCategory.CANCELLATION, ServiceType.INWARD, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.InwardProfessional),
    ...
    INWARD_THEATRE_PROFESSIONAL_FEE_BILL_CANCELLATION("Inward Theatre Professional Fee Bill Cancellation", BillCategory.CANCELLATION, ServiceType.INWARD, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.InwardProfessional),
    INWARD_APPOINTMENT_BILL("Inward Appointment Bill", BillCategory.BILL, ServiceType.INWARD, BillFinanceType.CASH_IN, CountedServiceType.INWARD, PaymentCategory.NON_CREDIT_SPEND, BillType.InwardAppointmentBill),
    INWARD_APPOINTMENT_CANCEL_BILL("Inward Appointment Cancel Bill", BillCategory.CANCELLATION, ServiceType.INWARD, BillFinanceType.CASH_OUT, CountedServiceType.INWARD, PaymentCategory.NON_CREDIT_SPEND, BillType.InwardAppointmentBill),
    INWARD_APPOINTMENT_BILL_REFUND("Inward Appointment Bill Refund", BillCategory.REFUND, ServiceType.INWARD, BillFinanceType.CASH_OUT, CountedServiceType.INWARD, PaymentCategory.NON_CREDIT_SPEND, BillType.InwardAppointmentBill),
    ...
    INWARD_PAYMENT("Inward Payment", BillCategory.BILL, ServiceType.INWARD, BillFinanceType.CASH_IN, CountedServiceType.INWARD, PaymentCategory.CREDIT_SPEND, BillType.InwardPaymentBill),
    INWARD_PAYMENT_CANCELLATION("Inward Payment Cancellation", BillCategory.CANCELLATION, ServiceType.INWARD, BillFinanceType.CASH_OUT, CountedServiceType.INWARD, PaymentCategory.CREDIT_SPEND, BillType.InwardPaymentBill),
    INWARD_PAYMENT_REFUND("Inward Payment Refund", BillCategory.REFUND, ServiceType.INWARD, BillFinanceType.CASH_OUT, CountedServiceType.INWARD, PaymentCategory.CREDIT_SPEND, BillType.InwardPaymentBill),
    INWARD_PAYMENT_REFUND_CANCELLATION("Inward Payment Refund Cancellation", BillCategory.CANCELLATION, ServiceType.INWARD, BillFinanceType.CASH_IN, CountedServiceType.INWARD, PaymentCategory.CREDIT_SPEND, BillType.InwardPaymentBill),
    POST_FINAL_BILL_INWARD_PAYMENT("Post Final Bill Inward Payment", BillCategory.BILL, ServiceType.INWARD, BillFinanceType.CASH_IN, CountedServiceType.INWARD, PaymentCategory.CREDIT_SPEND, BillType.PostFinalBillInwardPayment),
    POST_FINAL_BILL_INWARD_PAYMENT_CANCELLATION("Post Final Bill Inward Payment Cancellation", BillCategory.CANCELLATION, ServiceType.INWARD, BillFinanceType.CASH_OUT, CountedServiceType.INWARD, PaymentCategory.CREDIT_SPEND, BillType.PostFinalBillInwardPayment),
    POST_FINAL_BILL_INWARD_PAYMENT_REFUND("Post Final Bill Inward Payment Refund", BillCategory.REFUND, ServiceType.INWARD, BillFinanceType.CASH_OUT, CountedServiceType.INWARD, PaymentCategory.CREDIT_SPEND, BillType.PostFinalBillInwardPayment),
    ...
    DIRECT_ISSUE_INWARD_DISCHARGE_MEDICINE("Issue of Discharge Medicines to Inward Patients", BillCategory.BILL, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.PharmacyBhtPre),
    DIRECT_ISSUE_INWARD_DISCHARGE_MEDICINE_CANCELLATION("Issue of Discharge Medicines to Inward Patients Cancellation", BillCategory.CANCELLATION, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.PharmacyBhtPre),
    DIRECT_ISSUE_INWARD_DISCHARGE_MEDICINE_RETURN("Issue of Discharge Medicines to Inward Patients Return", BillCategory.REFUND, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.PharmacyBhtPre),
    DIRECT_ISSUE_THEATRE_MEDICINE("Direct Issue of Medicines to Theatre", BillCategory.BILL, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.PharmacyBhtPre),
    DIRECT_ISSUE_THEATRE_MEDICINE_CANCELLATION("Direct Issue of Medicines to Theatre Cancellation", BillCategory.CANCELLATION, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.PharmacyBhtPre),
    DIRECT_ISSUE_THEATRE_MEDICINE_RETURN("Direct Issue of Medicines to Theatre Return", BillCategory.REFUND, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.PharmacyBhtPre),
    ...
    REQUEST_MEDICINE_INWARD_PRE("Request Medicines for Inward Patients (Draft)", BillCategory.PREBILL, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.InwardPharmacyRequest),
    ...
    INWARD_SERVICE_ITEM_REQUEST("Inward Service/Item Request", BillCategory.BILL, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.InwardServiceItemRequest),
    INWARD_SERVICE_ITEM_REQUEST_CANCELLATION("Cancel Inward Service/Item Request", BillCategory.CANCELLATION, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.InwardServiceItemRequest),
    INWARD_SERVICE_ITEM_REJECTION("Reject Inward Service/Item Request", BillCategory.CANCELLATION, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.InwardServiceItemRequest),
    WARD_MEDICINE_ADMINISTRATION_CONSUMPTION("Ward Medicine Administration Consumption", BillCategory.BILL, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.PharmacyBhtPre),
    ...
    RETURN_MEDICINE_INWARD_CANCELLATION("Cancel Return Medicines Inward", BillCategory.CANCELLATION, ServiceType.INWARD_SERVICE, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.INWARD, PaymentCategory.NO_PAYMENT, BillType.PharmacyIssue),
    ...
    PHARMACY_STOCK_ADJUSTMENT_REQUEST("Pharmacy Stock Adjustment Request", BillCategory.BILL, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.CREDIT_SPEND, BillType.PharmacyAdjustmentApprovalRequest),
    PHARMACY_STAFF_STOCK_ADJUSTMENT_REQUEST("Pharmacy Staff Stock Adjustment Request", BillCategory.BILL, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.CREDIT_SPEND, BillType.PharmacyAdjustmentApprovalRequest),
    PHARMACY_PURCHASE_RATE_ADJUSTMENT_REQUEST("Pharmacy Purchase Rate Adjustment Request", BillCategory.BILL, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.CREDIT_SPEND, BillType.PharmacyAdjustmentApprovalRequest),
    PHARMACY_COST_RATE_ADJUSTMENT_REQUEST("Pharmacy Cost Rate Adjustment Request", BillCategory.BILL, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.CREDIT_SPEND, BillType.PharmacyAdjustmentApprovalRequest),
    PHARMACY_RETAIL_RATE_ADJUSTMENT_REQUEST("Pharmacy Retail Rate Adjustment Request", BillCategory.BILL, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.CREDIT_SPEND, BillType.PharmacyAdjustmentApprovalRequest),
    PHARMACY_WHOLESALE_RATE_ADJUSTMENT_REQUEST("Pharmacy Wholesale Rate Adjustment Request", BillCategory.BILL, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.CREDIT_SPEND, BillType.PharmacyAdjustmentApprovalRequest),
    ...
    PHARMACY_ISSUE_PRE("Pharmacy Transfer Issue Pre", BillCategory.PREBILL, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.NO_PAYMENT, BillType.PharmacyIssue),
    ...
    PHARMACY_DISPOSAL_ISSUE_PRE("Pharmacy Disposal Issue Pre", BillCategory.PREBILL, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.NO_PAYMENT, BillType.PharmacyDisposalIssue),
    ...
    PHARMACY_STOCK_EXPIRY_DATE_ADJUSTMENT_REQUEST("Pharmacy Stock Expiry Date Adjustment Request", BillCategory.BILL, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.NO_PAYMENT, BillType.PharmacyAdjustmentApprovalRequest),
    ...
    PHARMACY_STOCK_ADJUSTMENT_BILL("Pharmacy Stock Verification Adjustment Bill", BillCategory.BILL, ServiceType.PHARMACY, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.PHARMACY, PaymentCategory.NO_PAYMENT, BillType.PharmacyStockAdjustmentBill),
    PHARMACY_RETURN_WITHOUT_TREASING("Pharmacy Return without a Receipt", BillCategory.REFUND, ServiceType.PHARMACY, BillFinanceType.CASH_OUT, CountedServiceType.PHARMACY, PaymentCategory.NO_PAYMENT, BillType.PharmacySale),
    ...
    FUND_TRANSFER_BILL_DECLINED("Fund Transfer Bill - Declined", BillCategory.CANCELLATION, ServiceType.OTHER, BillFinanceType.FLOAT_INCREASE, CountedServiceType.OTHER, PaymentCategory.NON_CREDIT_SPEND, BillType.FundTransferBill),
    ...
    FUND_TRANSFER_REQUEST("Fund Transfer Request", BillCategory.BILL, ServiceType.OTHER, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.OTHER, PaymentCategory.NON_CREDIT_SPEND, BillType.FundTransferRequestBill),
    FUND_TRANSFER_REQUEST_CANCELLED("Fund Transfer Request - Cancelled", BillCategory.CANCELLATION, ServiceType.OTHER, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.OTHER, PaymentCategory.NON_CREDIT_SPEND, BillType.FundTransferRequestBill),
    FUND_TRANSFER_DENOMINATION_BILL("Fund Transfer Denomination Bill", BillCategory.BILL, ServiceType.OTHER, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.OTHER, PaymentCategory.OTHER, BillType.FundTransferBill),
    FUND_TRANSFER_RECEIVED_DENOMINATION_BILL("Fund Transfer Received Denomination Bill", BillCategory.BILL, ServiceType.OTHER, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.OTHER, PaymentCategory.OTHER, BillType.FundTransferReceivedBill),
    FUND_TRANSFER_REQUEST_DENOMINATION_BILL("Fund Transfer Request Denomination Bill", BillCategory.BILL, ServiceType.OTHER, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.OTHER, PaymentCategory.OTHER, BillType.FundTransferRequestBill),
    ...
    FUND_SHIFT_SHORTAGE_SETTLEMENT_BILL("Shift Shortage Settlement Bill", BillCategory.BILL, ServiceType.OTHER, BillFinanceType.FLOAT_DECREASE, CountedServiceType.OTHER, PaymentCategory.NO_PAYMENT, BillType.ShiftShortageSettlement),
    FUND_SHIFT_SHORTAGE_SETTLEMENT_BILL_CANCELLED("Shift Shortage Settlement Bill - Cancelled", BillCategory.CANCELLATION, ServiceType.OTHER, BillFinanceType.FLOAT_INCREASE, CountedServiceType.OTHER, PaymentCategory.NO_PAYMENT, BillType.ShiftShortageSettlement),
    HANDOVER_PROOF_MISSING_BILL("Handover Proof Missing Bill", BillCategory.BILL, ServiceType.OTHER, BillFinanceType.FLOAT_CHANGE, CountedServiceType.OTHER, PaymentCategory.NO_PAYMENT, BillType.HandoverProofMissing),
    HANDOVER_PROOF_MISSING_BILL_CANCELLED("Handover Proof Missing Bill - Cancelled", BillCategory.CANCELLATION, ServiceType.OTHER, BillFinanceType.FLOAT_CHANGE, CountedServiceType.OTHER, PaymentCategory.NO_PAYMENT, BillType.HandoverProofMissing),
    HANDOVER_PROOF_MISSING_SETTLEMENT_BILL("Handover Proof Missing Settlement Bill", BillCategory.BILL, ServiceType.OTHER, BillFinanceType.FLOAT_CHANGE, CountedServiceType.OTHER, PaymentCategory.NO_PAYMENT, BillType.HandoverProofMissingSettlement),
    HANDOVER_PROOF_MISSING_SETTLEMENT_BILL_CANCELLED("Handover Proof Missing Settlement Bill - Cancelled", BillCategory.CANCELLATION, ServiceType.OTHER, BillFinanceType.FLOAT_CHANGE, CountedServiceType.OTHER, PaymentCategory.NO_PAYMENT, BillType.HandoverProofMissingSettlement),
    PAYMENT_SETTLEMENT_BILL("Payment Settlement Bill", BillCategory.BILL, ServiceType.OTHER, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.OTHER, PaymentCategory.NO_PAYMENT, BillType.PaymentSettlementBill),
    PAYMENT_SETTLEMENT_BILL_CANCELLED("Payment Settlement Bill - Cancelled", BillCategory.CANCELLATION, ServiceType.OTHER, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.OTHER, PaymentCategory.NO_PAYMENT, BillType.PaymentSettlementBill),
    ...
    PETTY_CASH_PRE("Petty Cash Pre Bill", BillCategory.PAYMENTS, ServiceType.OTHER, BillFinanceType.NO_FINANCE_TRANSACTIONS, CountedServiceType.OTHER, PaymentCategory.NON_CREDIT_SPEND, BillType.PettyCash),
