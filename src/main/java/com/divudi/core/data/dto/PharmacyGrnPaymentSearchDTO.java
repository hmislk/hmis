...
/**
 * Lightweight DTO for pharmacy GRN payment search list (issue #20523).
 * Eliminates N+1 lazy-load storms from the old Bill-entity approach used by
 * {@code grn_payment.xhtml} (BillType.GrnPaymentPre).
 */
public class PharmacyGrnPaymentSearchDTO implements Serializable {
    ...
    public PharmacyGrnPaymentSearchDTO() {
    }
    ...
    public Date getReferenceBillCreatedAt() { return referenceBillCreatedAt; }
    public void setReferenceBillCreatedAt(Date referenceBillCreatedAt) { this.referenceBillCreatedAt = referenceBillCreatedAt; }
