...
/**
 * Lightweight DTO for pharmacy purchase return search list (issue #20523).
 * Eliminates N+1 lazy-load storms from the old Bill-entity approach used by
 * {@code purchase_return.xhtml} (BillType.PurchaseReturn).
 */
public class PharmacyPurchaseReturnSearchDTO implements Serializable {
