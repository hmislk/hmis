...
/**
 * Response DTO for MeasurementUnit.
 * Extends category response with unit-specific boolean flags and duration/frequency.
 *
 * @author Buddhika
 */
public class MeasurementUnitResponseDTO extends CategoryConfigResponseDTO implements Serializable {
    ...
    public MeasurementUnitResponseDTO() {
    }
