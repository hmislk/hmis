...
/**
 * Lightweight DTO for pharmacy return-without-traising bill search (issue #21014 / #20299).
 * Eliminates N+1 lazy-load storms from the old Bill-entity approach.
 */
public class PharmacyReturnWithoutTraisingSearchDTO implements Serializable {
    ...
    public PharmacyReturnWithoutTraisingSearchDTO() {
    }
    ...
    public Double getRetailSaleValue() { return retailSaleValue; }
    public void setRetailSaleValue(Double retailSaleValue) { this.retailSaleValue = retailSaleValue; }
