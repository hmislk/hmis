...
/**
 * DTO for MeasurementUnit operations
...
public class MeasurementUnitDTO implements Serializable {
    ...
    private String unitType;        // DoseUnit, FrequencyUnit, DurationUnit, etc.
     ...
     */
    public MeasurementUnitDTO(Long id, String name, String code, String description,
                            String unitType, boolean retired) {
        this.id = id;
        this.name = name;
        this.code = code;
