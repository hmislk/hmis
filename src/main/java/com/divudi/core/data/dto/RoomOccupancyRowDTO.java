...
public class RoomOccupancyRowDTO implements Serializable {
    ...
    public void addAdmissions(long count) {
        if (numberOfAdmissions == null) numberOfAdmissions = 0L;
     ...
     */
    public void ensureCategories(java.util.List<RoomCategory> allCategories) {
    ...
    public void merge(RoomOccupancyRowDTO other) {
        if (other.numberOfAdmissions != null) addAdmissions(other.numberOfAdmissions);
    ...
    public Long getNumberOfAdmissions() { return numberOfAdmissions; }
    public void setNumberOfAdmissions(Long v) { this.numberOfAdmissions = v; }

    public Map<RoomCategory, RoomCategoryOccupancyDTO> getCategoryMetrics() {
        if (categoryMetrics == null) categoryMetrics = new LinkedHashMap<>();
        return categoryMetrics;
    }
    public void setCategoryMetrics(Map<RoomCategory, RoomCategoryOccupancyDTO> v) { categoryMetrics = v; }

    public RoomBedOccupancyDTO getIcuOccupancy() { return icuOccupancy; }
    public void setIcuOccupancy(RoomBedOccupancyDTO v) { icuOccupancy = v; }

    public RoomBedOccupancyDTO getWardBedOldOccupancy() { return wardBedOldOccupancy; }
    public void setWardBedOldOccupancy(RoomBedOccupancyDTO v) { wardBedOldOccupancy = v; }

    public RoomBedOccupancyDTO getWardBedNewOccupancy() { return wardBedNewOccupancy; }
    public void setWardBedNewOccupancy(RoomBedOccupancyDTO v) { wardBedNewOccupancy = v; }

    public Long   getIndoorTotalDaysOccupied()  { return indoorTotalDaysOccupied; }
    public void   setIndoorTotalDaysOccupied(Long v) { indoorTotalDaysOccupied = v; }
    public Long   getIndoorTotalNumberOfRooms()  { return indoorTotalNumberOfRooms; }
    public void   setIndoorTotalNumberOfRooms(Long v) { indoorTotalNumberOfRooms = v; }
    public Double getIndoorTotalRatio()  { return indoorTotalRatio; }
    public void   setIndoorTotalRatio(Double v) { indoorTotalRatio = v; }
    public Double getIndoorTotalAvg()    { return indoorTotalAvg; }
    public void   setIndoorTotalAvg(Double v) { indoorTotalAvg = v; }

    public Long   getIcuWardTotalDaysOccupied()  { return icuWardTotalDaysOccupied; }
    public void   setIcuWardTotalDaysOccupied(Long v) { icuWardTotalDaysOccupied = v; }
    public Long   getIcuWardTotalNumberOfBeds()  { return icuWardTotalNumberOfBeds; }
    public void   setIcuWardTotalNumberOfBeds(Long v) { icuWardTotalNumberOfBeds = v; }
    public Double getIcuWardRatio()  { return icuWardRatio; }
    public void   setIcuWardRatio(Double v) { icuWardRatio = v; }
    public Double getIcuWardAvg()    { return icuWardAvg; }
    public void   setIcuWardAvg(Double v) { icuWardAvg = v; }

    public boolean isGrandTotal() { return grandTotal; }
    public void setGrandTotal(boolean v) { grandTotal = v; }
