...
//    /sessions/DR0001
    ...
    @Produces("application/json")
    public String getLimsResponse(@PathParam("username") String username, @PathParam("password") String password,
             @PathParam("machine") String machine, @PathParam("msg") String msg) {
        ...
        if (loginSUccessful == false) {
            ...
            object.put("msg", "Username and / or password wrong.");
        ...
        try {
            List<ServiceSession> sessions = sessionsList(temStr, null, null);
            if (!sessions.isEmpty()) {
...
//            s[10]=fetchLocalFee((long)s[0], PaymentMethod.Agent, true);
                ...
                jSONObjectOut.put("session_dates", sessionsDatesList(temStr, null, null));
                jSONObjectOut.put("error", "0");
                jSONObjectOut.put("error_description", "");
            } else {
