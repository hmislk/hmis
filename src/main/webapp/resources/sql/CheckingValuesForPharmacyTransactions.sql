...
select `ID`, `QTY`, `RETAILRATE`, `PURCHASERATE`, `PURCHASERATEPACK`, `RETAILRATEPACK`, `PURCHASEVALUE`, `RETAILVALUE`, `STOCK_ID`, `ITEMBATCH_ID` from pharmaceuticalbillitem order by id desc limit 2;
