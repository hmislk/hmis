select `ID`, `CREATEDAT`,  `DTYPE`, `BILLTYPE`, `BILLTYPEATOMIC`, `DEPTID`, COMPLETED, `CHECKED`,  `REFERENCEBILL_ID`,  BACKWARDREFERENCEBILL_ID,  `DEPARTMENT_ID`, `INSTITUTION_ID`, `NETTOTAL` , `PAYMENTMETHOD`, `REFERENCEBILL_ID`,  `DEPARTMENT_ID`,  FROMDEPARTMENT_ID, TODEPARTMENT_ID,  `INSTITUTION_ID`, `FROMINSTITUTION_ID`, `TOINSTITUTION_ID`, `BILLEDBILL_ID`
from BILL 
