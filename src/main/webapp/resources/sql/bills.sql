select `ID`, `CREATEDAT`,  `DTYPE`, `BILLTYPE`, `BILLTYPEATOMIC`, `DEPTID`,`DEPARTMENT_ID`, `INSTITUTION_ID`, `NETTOTAL` , `PAYMENTMETHOD`, `REFERENCEBILL_ID`,  `DEPARTMENT_ID`,  FROMDEPARTMENT_ID, TODEPARTMENT_ID,  `INSTITUTION_ID`, `FROMINSTITUTION_ID`, `TOINSTITUTION_ID`, `BILLEDBILL_ID`, `REFERENCEBILL_ID`
from BILL 
