select `ID`, `DTYPE`, `BILLTYPE`, `BILLTYPEATOMIC`, `DEPTID`, `NETTOTAL` , `PAYMENTMETHOD`, `REFERENCEBILL_ID`,  `DEPARTMENT_ID`, `INSTITUTION_ID`, `FROMINSTITUTION_ID`, `TOINSTITUTION_ID`
from bill 
