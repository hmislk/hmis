...
<f:view>
    <html>
        <head>
            ...
            <title>New PersonInstitution</title>
        ...
        <body>
            ...
            <h1>New PersonInstitution</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{personInstitution.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{personInstitution.create}" value="Create"/>
                <br />
                <br />
