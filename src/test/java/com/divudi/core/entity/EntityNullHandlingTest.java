...
/**
 * Tests null-handling behavior in BigDecimal entity fields.
 * Validates that entities properly handle nullable BigDecimal fields
 * after the BigDecimal refactoring initiative.
 * 
...
public class EntityNullHandlingTest {
    ...
    class BillItemFinanceDetailsTest {
        ...
        public void testComplexNullScenarios_ShouldNotThrowException() {
            ...
            // Set various combinations of null fields
            entity.setQuantity(null);
            entity.setLineGrossRate(null);
            entity.setGrossTotal(new BigDecimal("0.00")); // Explicit zero
            entity.setNetTotal(null);
            entity.setLineDiscount(null);
            entity.setBillTax(BigDecimal.ZERO); // Another explicit zero
            
            assertDoesNotThrow(() -> {
                // Test that standard Object methods work
                String str = entity.toString();
                assertNotNull(str);
                
                int hash = entity.hashCode();
                
                BillItemFinanceDetails other = new BillItemFinanceDetails();
                boolean isEqual = entity.equals(other);
                
                // Test clone with mixed null/zero values
