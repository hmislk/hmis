...
Thanks for your interest in hims. Our goal is to bring fast, open-source hospital information management system.

## Getting Started

hims's [open issues are here](https://github.com/buddhika75/hims/issues). In time, we'll tag issues that would make a good first pull request for new contributors. An easy way to get started helping the project is to *file an issue*. You can do that on the Deeplearning4j issues page by clicking on the green button at the right. Issues can include bugs to fix, features to add, or documentation that looks outdated. 
...
hims welcomes contributions from everyone.

Contributions to hims should be made in the form of GitHub pull requests. Each pull request will
